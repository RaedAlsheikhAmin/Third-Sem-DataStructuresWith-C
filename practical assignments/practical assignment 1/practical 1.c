...
int main()
{
    ...
    con=load_data(filename);//calling the function and assigning the strucutre that is returned to a strucutre pointer that i will use.    printf("The earthquake characteristics is successfully loaded. \n---------------------------------------------------------------\n");
